...
void exti_init(exti_conf_t *conf, exti_handle_t *handle);
void exti_enable_line(uint8_t im);
void exti_gpio_init(exti_conf_t *conf, exti_handle_t *handle);
void exti_deinit(exti_handle_t *handle);
void exti_gpio_deinit(exti_handle_t *handle);
