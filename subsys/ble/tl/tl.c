...
PLACE_IN_SECTION("MAPPING_TABLE") static volatile struct mb_ref_table g_mb_ref_table;
PLACE_IN_SECTION("MB_MEM1") ALIGN(4) static struct mb_device_info_table g_mb_device_info_table;
PLACE_IN_SECTION("MB_MEM1") ALIGN(4) static struct mb_ble_table g_mb_ble_table;
PLACE_IN_SECTION("MB_MEM1") ALIGN(4) static struct mb_sys_table g_mb_sys_table;
PLACE_IN_SECTION("MB_MEM1") ALIGN(4) static struct mb_mem_manager_table g_mb_mem_manager_table;
PLACE_IN_SECTION("MB_MEM1") ALIGN(4) static struct mb_traces_table g_mb_traces_table;
...
{
	((tl_cmd_packet_t *)(g_mb_ref_table.p_sys_table->p_cmd_buffer))->cmd_serial.type =
		TL_SYSCMD_PKT_TYPE;
...
{
	((tl_cmd_packet_t *)(g_mb_ref_table.p_ble_table->p_cmd_buffer))->cmd_serial.type =
		TL_BLECMD_PKT_TYPE;
...
{
	((tl_acl_data_packet_t *)(g_mb_ref_table.p_ble_table->p_hci_acl_data_buffer))
