...
typedef struct
{
    mb_device_info_table_t *p_device_info_table;
    mb_ble_table_t *p_ble_table;
    mb_thread_table_t *p_thread_table;
    mb_sys_table_t *p_sys_table;
    mb_mem_manager_table_t *p_mem_manager_table;
    mb_traces_table_t *p_traces_table;
    mb_mac_802_15_4_t *p_mac_802_15_4_table;
    mb_zigbee_table_t *p_zigbee_table;
    mb_lld_tests_table_t *p_lld_tests_table;
    mb_ble_lld_table_t *p_ble_lld_table;
} mb_ref_table_t;
