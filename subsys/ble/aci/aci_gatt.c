                                    ...
                                    uint16_t *char_desc_handle)
{
    ...
    index_input += 1;
    {
        ...
        index_input += 1;
        memcpy((void *)&cp1->char_desc_value, (const void *)char_desc_value, char_desc_value_length);
                                               ...
                                               const handle_entry_t *handle_entry)
{
    ...
    index_input += 1;
    memcpy((void *)&cp0->handle_entry,
           (const void *)handle_entry,
