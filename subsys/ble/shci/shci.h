...
#include "subsys/ble/tl/tl_mbox.h"

/* Exported types ------------------------------------------------------------*/

/* SYSTEM EVENT */
enum shci_sysevt_ready_rsp {
...
{
	enum shci_sysevt_ready_rsp sys_evt_ready_rsp;
}
shci_c2_ready_evt_t;
...
enum shci_fus_getstate_error_code {
...
shci_c2_fus_update_auth_key_cmd_param_t;
...
enum { KEYSIZE_16 = 16, KEYSIZE_32 = 32, KEYSIZE_64 = 64 };

typedef PACKED_STRUCT
{
	uint8_t key_type;
	uint8_t key_size;
	uint8_t key_data[32 + 12];
}
shci_c2_fus_store_usr_key_cmd_param_t;
...
/** command parameters */
enum shci_c2_concurrent_mode_param {
	BLE_ENABLE,
	THREAD_ENABLE,
	ZIGBEE_ENABLE,
	MAC_ENABLE,
...
shci_c2_concurrent_get_next_ble_evt_time_param_t;
/** No response parameters*/
...
/** Command parameters */
enum shci_c2_set_flash_activity_control_source {
...
/**
   ...
   * @retval SHCI_Success
   */
enum shci_cmd_status shci_get_wireless_fw_info(struct wireless_fw_info *pwirelessinfo);
