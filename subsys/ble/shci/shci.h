...
enum shci_sys_err_code {
	...
	ERR_THREAD_UNKNOWN_CMD = 126, /* The command send by the CPU1 to control */
	ERR_ZIGBEE_UNKNOWN_CMD = 200, /* The command send by the CPU1 to control */
};
...
{
	enum shci_sys_evt_ready_rsp sysevt_ready_rsp;
}
shci_c2_ready_evt_t;
...
typedef PACKED_STRUCT
{
	enum shci_sys_err_code error_code;
}
